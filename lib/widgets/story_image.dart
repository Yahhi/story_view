...
class ImageLoader {
  ...
  void loadImage(VoidCallback onComplete) {
    ...
    final fileStream = DefaultCacheManager().getFileStream(this.url, headers: requestHeaders == null ? null : this.requestHeaders as Map<String, String>);
...
class StoryImageState extends State<StoryImage> {
  ...
  void forward() async {
    ...
    if (nextFrame?.duration != null && nextFrame!.duration > Duration(milliseconds: 0)) {
